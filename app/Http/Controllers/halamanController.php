...
class halamanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('halaman.index')->with('success', 'Data berhadil ditambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('halaman.index')->with('success', 'Data berhasil di update');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('halaman.index')->with('success', 'Data berhasil di delete');
    }
}
